...
import 'package:flutter_project/majorSubList%20A.dart';
import 'package:flutter_project/majorSubList.dart';
import 'lectureEvaluation.dart';
import 'package:flutter_project/timetable B.dart';
import 'package:flutter_project/lectureEvaluation A.dart';

class SelectionA extends StatelessWidget {
  @override
      ...
      leading: IconButton(
        ...
        onPressed: () {
          Navigator.of(context).push(
            MaterialPageRoute(builder: (context) => MajorSubA()),
          );
        },
      ),
      actions: [
            ...
            Expanded(
              child: ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => OtherPageA()),
                  );
                },
...
class Subject_02 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.stretch,
...
class Subject_03 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.stretch,
...
class Subject_04 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.stretch,
...
class Subject_05 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.stretch,
