...
import 'package:flutter_project/search B.dart';
import 'package:flutter/material.dart';
import 'package:flutter_project/timetable.dart';

class MajorSubB extends StatelessWidget {
  @override
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => SearchPageB()),
            );
          },
        ),
        title: Text(
          ...
          body: Column(
            children: widget.subItems.map((subItem) {
              return ListTile(
                ...
                onTap: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => SelectionB()),
                  );
                },
              );
            }).toList(),
